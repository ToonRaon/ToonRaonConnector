...
echo 1. www.googleadservices.com 패치 추가
echo 2. cm.g.doubleclick.net 패치 추가(127.0.0.1)
echo 3. googleads.g.doubleclick.net 패치 추가(127.0.0.1)
echo 4. pagead2.googlesyndication.com 패치 추가(127.0.0.1)
